...
The file `ExImag.sage` contains the computations for Theorem 7.2 of [LL25]. Using the Affine Chabauty method developed in that paper it is verified that the affine hyperelliptic curve [1549.a.1549.1](https://www.lmfdb.org/Genus2Curve/Q/1549/a/1549/1) defined by
